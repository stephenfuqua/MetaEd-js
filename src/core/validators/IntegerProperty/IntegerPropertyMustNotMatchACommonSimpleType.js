...
export function validatable(ruleContext: any): ValidatableResult {
  const validatorName = 'IntegerPropertyMustNotMatchACommonSimpleType';
...
function failureMessage(ruleContext: any, symbolTable: SymbolTable): string {
  return `Integer property '${ruleContext.propertyName().ID().getText()}' has the same name as a Shared Decimal, Integer, Short or String.  If intentional, use a shared property instead.`;
}
