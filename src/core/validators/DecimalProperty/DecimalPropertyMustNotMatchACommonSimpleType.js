...
function failureMessage(ruleContext: any, symbolTable: SymbolTable): string {
  return `Decimal property '${ruleContext.propertyName().ID().getText()}' has the same name as a Shared Decimal, Integer, Short or String.  If intentional, use a shared property instead.`;
}
