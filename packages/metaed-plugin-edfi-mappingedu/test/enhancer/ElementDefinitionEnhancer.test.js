...
import type { ElementDefinition } from '../../src/model/ElementDefinition';
...
describe('when enhancing descriptor', () => {
  ...
  beforeAll(() => {
    ...
    pluginBasesForNamespace(metaEd, namespace).set(baseTypeDescriptor, {
      ...
      items: [
        { ...newElement(), name: codeValue, annotation: { ...newAnnotation(), documentation: codeValueDocumentation } },
        {
          ...newElement(),
...
describe('when enhancing descriptor with map type', () => {
  ...
  beforeAll(() => {
    ...
    pluginDescriptorsForNamespace(metaEd, namespace).set(descriptorName, {
      ...
      annotation: { ...newAnnotation() },
      name: descriptorName,
      items: [{ ...newElement(), name: descriptorNameMap, type: descriptorNameMapType }],
    });
    pluginDescriptorsForNamespace(metaEd, namespace).set(descriptorName, {
      ...newComplexType(),
      baseType: baseTypeDescriptor,
