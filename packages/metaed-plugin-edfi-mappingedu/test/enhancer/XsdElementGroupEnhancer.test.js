...
import type { ComplexType, SimpleType } from 'metaed-plugin-edfi-xsd';
...
describe('when enhancing entity definitions', () => {
  ...
  beforeAll(() => {
    ...
    const namespace: Namespace = {
      ...
      data: { edfiXsd: { xsd_Schema: newSchemaContainer() } },
    };

    namespace.data.edfiXsd.xsd_Schema.sections.push({
      ...newSchemaSection(),
  ...
  it.each([
    ...
    const xsdElement: ComplexType | SimpleType = (pluginNamespace.xsdElement[typeName].get(elementName): any);
