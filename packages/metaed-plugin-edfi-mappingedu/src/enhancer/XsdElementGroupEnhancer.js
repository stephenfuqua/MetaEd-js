...
import type { SchemaSection, ComplexType, EnumerationSimpleType, SimpleType } from 'metaed-plugin-edfi-xsd';
import {
...
): Map<string, ComplexType> | Map<string, SimpleType> | Map<string, EnumerationSimpleType> => {
  const repositoryFor: {
    [string]: () => Map<string, ComplexType> | Map<string, SimpleType> | Map<string, EnumerationSimpleType>,
  } = {
