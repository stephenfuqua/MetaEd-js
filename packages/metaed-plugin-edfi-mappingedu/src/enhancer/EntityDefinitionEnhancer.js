...
import type { ComplexType, SimpleType, Element, ElementGroup, ComplexTypeItem } from 'metaed-plugin-edfi-xsd';
...
const createEntityDefinitionsFor = (
  ...
  while (elements.length > 0) {
    ...
    const referencedComplexType: ComplexType = asComplexType(reference);
