import { newDescriptor, PluginEnvironment } from '@edfi/metaed-core';
...
describe('when enhancing core descriptor targeting 3.3 ODS/API', (): void => {
  const namespaceName = 'EdFi';
  const metaEdName = 'MetaEdName';
  const tableName = 'TableName';
  const pkColumnName = 'PkColumnName';
...
describe('when enhancing extension descriptor targeting 3.3 ODS/API', (): void => {
  const namespaceName = 'Extension';
  const metaEdName = 'MetaEdName';
  const tableName = 'TableName';
  const pkColumnName = 'PkColumnName';
...
describe('when enhancing core descriptor targeting 3.4 ODS/API', (): void => {
  const namespaceName = 'EdFi';
  const metaEdName = 'MetaEdName';
  const tableName = 'TableName';
...
describe('when enhancing extension descriptor targeting 3.4 ODS/API', (): void => {
  const namespaceName = 'Extension';
  const metaEdName = 'MetaEdName';
  const tableName = 'TableName';
  const primaryKeyName = 'PrimaryKeyName';
