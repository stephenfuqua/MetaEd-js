...
import { generateCreateTrackedDeleteTables } from '@edfi/metaed-plugin-edfi-ods-changequery';
...
export async function generate(metaEd: MetaEdEnvironment): Promise<GeneratorResult> {
  const results = generateCreateTrackedDeleteTables(metaEd, PLUGIN_NAME, template, databaseSpecificFolderName);
  return {
    generatorName,
