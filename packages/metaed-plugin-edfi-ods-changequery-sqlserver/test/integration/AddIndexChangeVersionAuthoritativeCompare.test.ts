...
describe('when generating add index changeversion and comparing to ODS/API 5.4 authoritative artifacts', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/add-index-changeversion');
  const authoritativeCoreFilename = 'AddIndexChangeVersion-v5.4-Authoritative.sql';
  const generatedCoreFilename = 'AddIndexChangeVersion-v5.4.sql';
