...
describe('when generating OpenAPI spec for data standard 5.1 and TPDM 1.1 for ODS/API 7.2', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v7_2/');
  const authoritativeCoreFilename = 'ds-5.1-open-api-authoritative.json';
  const generatedCoreFilename = 'ds-5.1-open-api-generated.json';
  const authoritativeExtensionFilename = 'tpdm-open-api-authoritative.json';
  const generatedExtensionFilename = 'tpdm-open-api-generated.json';
