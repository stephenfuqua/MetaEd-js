...
import { enhance } from '../../src/enhancer/AssociationChangeEventEnhancer';
...
describe('when enhancing core association targeting 2.3 ODS/API', () => {
...
describe('when enhancing core association targeting 2.4 ODS/API', () => {
  const namespaceName: string = 'edfi';
  const metaEdName: string = 'MetaEdName';
  const tableName: string = 'TableName';
  const pkColumnName: string = 'PkColumnName';
...
describe('when enhancing extension association targeting 2.4 ODS/API', () => {
...
describe('when enhancing core association targeting 3.1 ODS/API', () => {
  const namespaceName: string = 'edfi';
  const metaEdName: string = 'MetaEdName';
  const tableName: string = 'TableName';
  const pkColumnName: string = 'PkColumnName';
...
describe('when enhancing extension association targeting 3.1 ODS/API', () => {
  const namespaceName: string = 'extension';
  const metaEdName: string = 'MetaEdName';
  const tableName: string = 'TableName';
  const pkColumnName: string = 'PkColumnName';
