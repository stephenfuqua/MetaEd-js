// @flow
import { newSchoolYearEnumeration } from 'metaed-core';
...
import { enhance } from '../../src/enhancer/SchoolYearEnumerationChangeEventEnhancer';
...
describe('when enhancing core schoolYearEnumeration targeting 2.3 ODS/API', () => {
...
describe('when enhancing core schoolYearEnumeration targeting 2.4 ODS/API', () => {
  const namespaceName: string = 'edfi';
  const metaEdName: string = 'MetaEdName';
  const tableName: string = 'TableName';
  const pkColumnName: string = 'PkColumnName';
...
describe('when enhancing extension schoolYearEnumeration targeting 2.4 ODS/API', () => {
...
describe('when enhancing core schoolYearEnumeration targeting 3.1 ODS/API', () => {
  const namespaceName: string = 'edfi';
  const metaEdName: string = 'MetaEdName';
  const tableName: string = 'TableName';
  const pkColumnName: string = 'PkColumnName';
...
describe('when enhancing extension schoolYearEnumeration targeting 3.1 ODS/API', () => {
  const namespaceName: string = 'extension';
  const metaEdName: string = 'MetaEdName';
  const tableName: string = 'TableName';
  const pkColumnName: string = 'PkColumnName';
