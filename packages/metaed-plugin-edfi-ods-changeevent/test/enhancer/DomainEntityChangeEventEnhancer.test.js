...
import { enhance } from '../../src/enhancer/DomainEntityChangeEventEnhancer';
...
describe('when enhancing core domainEntity targeting 2.4 ODS/API', () => {
  const namespaceName: string = 'edfi';
  const metaEdName: string = 'MetaEdName';
  const tableName: string = 'TableName';
  const pkColumnName: string = 'PkColumnName';
...
describe('when enhancing extension domainEntity targeting 2.4 ODS/API', () => {
