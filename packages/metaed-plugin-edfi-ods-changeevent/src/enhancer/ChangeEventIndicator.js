...
export function changeEventPossible(metaEd: MetaEdEnvironment): boolean {
  ...
  if (versionSatisfies(edfiOdsPlugin.targetTechnologyVersion, '>=2.4.0 <3.0.0')) return true;
...
export function twoDotXIndicated(metaEd: MetaEdEnvironment, currentNamespace: Namespace): boolean {
  ...
  if (!versionSatisfies(edfiOdsPlugin.targetTechnologyVersion, '>=2.4.0 <3.0.0')) return false;
