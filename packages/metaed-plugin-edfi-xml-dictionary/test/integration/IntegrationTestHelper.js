...
import initializeXsdPlugin from '../../../metaed-plugin-edfi-xsd/src/edfiXsd';
import { generate } from '../../../metaed-plugin-edfi-xsd/src/generator/XsdGenerator';
...
export function enhanceAndGenerateXsdForTests(metaEd: MetaEdEnvironment) {
