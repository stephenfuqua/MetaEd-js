  ...
  metaEd.entity.domainEntitySubclass.forEach(domainEntitySubclass => {
    ...
    if (domainEntitySubclass.baseEntityName === 'AssessmentFamily') {
      failures.push({
        ...
        category: 'warning',
        message: `${domainEntitySubclass.typeHumanizedName} ${domainEntitySubclass.metaEdName} is an AssessmentFamily subclass.  AssessmentFamily subclasses are currently unsupported by the ODS/API.`,
