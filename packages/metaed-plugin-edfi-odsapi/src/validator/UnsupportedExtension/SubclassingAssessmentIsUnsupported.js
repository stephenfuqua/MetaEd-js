  ...
  metaEd.entity.domainEntitySubclass.forEach(domainEntitySubclass => {
    ...
    if (domainEntitySubclass.baseEntityName === 'Assessment') {
      failures.push({
        ...
        category: 'warning',
        message: `${domainEntitySubclass.typeHumanizedName} ${domainEntitySubclass.metaEdName} is an Assessment subclass.  Assessment subclasses are currently unsupported by the ODS/API.`,
