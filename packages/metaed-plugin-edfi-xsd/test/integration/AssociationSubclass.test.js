...
import { newMetaEdEnvironment, MetaEdTextBuilder, DomainEntityBuilder, AssociationBuilder, AssociationSubclassBuilder, NamespaceInfoBuilder } from '../../../metaed-core/index';
...
describe('when generating xsd for association extension in extension namespace based on core association', () => {
  ...
  const extensionAssociationProperty: string = 'ExtensionAssociationProperty';
