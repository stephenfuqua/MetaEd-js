...
const schemaDocumentation: string = 'Documentation';
const schemaVersion: string = '200';

const schemaSectionDocumentation: string = 'Schema Section Documentation';

const complexTypeName: string = 'Complex Type Name';
const complexTypeDocumentation: string = 'Complex Type Documentatio';

const simpleTypeName: string = 'Simple Type Name';
const simpleTypeBaseType: string = 'xs:string';
const simpleTypeDocumentation: string = 'Simple Type Documentation';
