...
(
       ...
       CONSTRAINT PK_edfi_AbsenceEventCategoryDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (AbsenceEventCategoryDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_AcademicHonorCategoryDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (AcademicHonorCategoryDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_AccountClassificationDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (AccountClassificationDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_AccountCode_TrackedDelete PRIMARY KEY CLUSTERED (AccountClassificationDescriptorId, AccountCodeNumber, EducationOrganizationId, FiscalYear)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_Account_TrackedDelete PRIMARY KEY CLUSTERED (AccountIdentifier, EducationOrganizationId, FiscalYear)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_Actual_TrackedDelete PRIMARY KEY CLUSTERED (AccountIdentifier, AsOfDate, EducationOrganizationId, FiscalYear)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_AdditionalCreditTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (AdditionalCreditTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_AddressTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (AddressTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_AdministrationEnvironmentDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (AdministrationEnvironmentDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_AssessmentItemCategoryDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (AssessmentItemCategoryDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_AssessmentItemResultDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (AssessmentItemResultDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_AssessmentItem_TrackedDelete PRIMARY KEY CLUSTERED (AcademicSubjectDescriptorId, AssessedGradeLevelDescriptorId, AssessmentTitle, AssessmentVersion, IdentificationCode)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_AssessmentReportingMethodDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (AssessmentReportingMethodDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_Assessment_TrackedDelete PRIMARY KEY CLUSTERED (AcademicSubjectDescriptorId, AssessedGradeLevelDescriptorId, AssessmentTitle, AssessmentVersion)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_AttemptStatusDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (AttemptStatusDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_BellSchedule_TrackedDelete PRIMARY KEY CLUSTERED (BellScheduleName, SchoolId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_Budget_TrackedDelete PRIMARY KEY CLUSTERED (AccountIdentifier, AsOfDate, EducationOrganizationId, FiscalYear)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CalendarDate_TrackedDelete PRIMARY KEY CLUSTERED (CalendarCode, Date, SchoolId, SchoolYear)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CalendarTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CalendarTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_Calendar_TrackedDelete PRIMARY KEY CLUSTERED (CalendarCode, SchoolId, SchoolYear)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CareerPathwayDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CareerPathwayDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CharterApprovalAgencyTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CharterApprovalAgencyTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CharterStatusDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CharterStatusDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CitizenshipStatusDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CitizenshipStatusDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CohortScopeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CohortScopeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CohortTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CohortTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CohortYearTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CohortYearTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CommunityOrganization_TrackedDelete PRIMARY KEY CLUSTERED (CommunityOrganizationId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CommunityProviderLicense_TrackedDelete PRIMARY KEY CLUSTERED (CommunityProviderId, LicenseIdentifier, LicensingOrganization)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CommunityProvider_TrackedDelete PRIMARY KEY CLUSTERED (CommunityProviderId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ContactTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ContactTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ContentClassDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ContentClassDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ContractedStaff_TrackedDelete PRIMARY KEY CLUSTERED (AccountIdentifier, AsOfDate, EducationOrganizationId, FiscalYear, StaffUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CostRateDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CostRateDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CourseAttemptResultDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CourseAttemptResultDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CourseDefinedByDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CourseDefinedByDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CourseGPAApplicabilityDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CourseGPAApplicabilityDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CourseLevelCharacteristicDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CourseLevelCharacteristicDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CourseOffering_TrackedDelete PRIMARY KEY CLUSTERED (LocalCourseCode, SchoolId, SchoolYear, SessionName)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CourseRepeatCodeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CourseRepeatCodeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CourseTranscript_TrackedDelete PRIMARY KEY CLUSTERED (CourseAttemptResultDescriptorId, CourseCode, CourseEducationOrganizationId, EducationOrganizationId, SchoolYear, StudentUSI, TermDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CredentialTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CredentialTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_Credential_TrackedDelete PRIMARY KEY CLUSTERED (CredentialIdentifier, StateOfIssueStateAbbreviationDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CreditTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CreditTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CurriculumUsedDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (CurriculumUsedDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_DeliveryMethodDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (DeliveryMethodDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_DiplomaLevelDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (DiplomaLevelDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_DiplomaTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (DiplomaTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_DisabilityDesignationDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (DisabilityDesignationDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_DisabilityDeterminationSourceTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (DisabilityDeterminationSourceTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_DisciplineActionLengthDifferenceReasonDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (DisciplineActionLengthDifferenceReasonDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_EducationOrganizationCategoryDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (EducationOrganizationCategoryDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_EducationPlanDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (EducationPlanDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_EducationalEnvironmentDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (EducationalEnvironmentDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ElectronicMailTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ElectronicMailTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_EntryGradeLevelReasonDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (EntryGradeLevelReasonDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_EventCircumstanceDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (EventCircumstanceDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_GeneralStudentProgramAssociation_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_GradeTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (GradeTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_Grade_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, GradeTypeDescriptorId, GradingPeriodDescriptorId, GradingPeriodSchoolYear, GradingPeriodSequence, LocalCourseCode, SchoolId, SchoolYear, SectionIdentifier, SessionName, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_GradebookEntryTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (GradebookEntryTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_GradebookEntry_TrackedDelete PRIMARY KEY CLUSTERED (DateAssigned, GradebookEntryTitle, LocalCourseCode, SchoolId, SchoolYear, SectionIdentifier, SessionName)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_GradingPeriod_TrackedDelete PRIMARY KEY CLUSTERED (GradingPeriodDescriptorId, PeriodSequence, SchoolId, SchoolYear)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_GunFreeSchoolsActReportingStatusDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (GunFreeSchoolsActReportingStatusDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_HomelessPrimaryNighttimeResidenceDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (HomelessPrimaryNighttimeResidenceDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_HomelessProgramServiceDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (HomelessProgramServiceDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_IdentificationDocumentUseDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (IdentificationDocumentUseDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_IncidentLocationDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (IncidentLocationDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_InstitutionTelephoneNumberTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (InstitutionTelephoneNumberTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_InteractivityStyleDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (InteractivityStyleDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_InternetAccessDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (InternetAccessDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_InterventionClassDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (InterventionClassDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_InterventionEffectivenessRatingDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (InterventionEffectivenessRatingDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_LanguageInstructionProgramServiceDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (LanguageInstructionProgramServiceDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_LanguageUseDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (LanguageUseDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_LearningStandardCategoryDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (LearningStandardCategoryDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_LicenseStatusDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (LicenseStatusDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_LicenseTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (LicenseTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_LocalEducationAgencyCategoryDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (LocalEducationAgencyCategoryDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_MagnetSpecialProgramEmphasisSchoolDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (MagnetSpecialProgramEmphasisSchoolDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_MediumOfInstructionDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (MediumOfInstructionDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_MethodCreditEarnedDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (MethodCreditEarnedDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_MigrantEducationProgramServiceDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (MigrantEducationProgramServiceDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_MonitoredDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (MonitoredDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_NeglectedOrDelinquentProgramDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (NeglectedOrDelinquentProgramDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_NeglectedOrDelinquentProgramServiceDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (NeglectedOrDelinquentProgramServiceDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_NetworkPurposeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (NetworkPurposeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ObjectiveAssessment_TrackedDelete PRIMARY KEY CLUSTERED (AcademicSubjectDescriptorId, AssessedGradeLevelDescriptorId, AssessmentTitle, AssessmentVersion, IdentificationCode)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_OldEthnicityDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (OldEthnicityDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_OpenStaffPosition_TrackedDelete PRIMARY KEY CLUSTERED (EducationOrganizationId, RequisitionNumber)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_OperationalStatusDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (OperationalStatusDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_OtherNameTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (OtherNameTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ParticipationDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ParticipationDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_Payroll_TrackedDelete PRIMARY KEY CLUSTERED (AccountIdentifier, AsOfDate, EducationOrganizationId, FiscalYear, StaffUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_PerformanceBaseConversionDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (PerformanceBaseConversionDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_PersonalInformationVerificationDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (PersonalInformationVerificationDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_PopulationServedDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (PopulationServedDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_PostSecondaryEventCategoryDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (PostSecondaryEventCategoryDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_PostSecondaryEvent_TrackedDelete PRIMARY KEY CLUSTERED (EventDate, PostSecondaryEventCategoryDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_PostSecondaryInstitutionLevelDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (PostSecondaryInstitutionLevelDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_PostSecondaryInstitution_TrackedDelete PRIMARY KEY CLUSTERED (PostSecondaryInstitutionId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_PostingResultDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (PostingResultDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ProficiencyDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ProficiencyDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ProgramSponsorDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ProgramSponsorDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ProgramTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ProgramTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_Program_TrackedDelete PRIMARY KEY CLUSTERED (EducationOrganizationId, ProgramName, ProgramTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ProgressDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ProgressDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ProgressLevelDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ProgressLevelDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ProviderCategoryDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ProviderCategoryDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ProviderProfitabilityDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ProviderProfitabilityDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ProviderStatusDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ProviderStatusDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_PublicationStatusDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (PublicationStatusDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_RaceDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (RaceDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ReasonNotTestedDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ReasonNotTestedDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_RecognitionTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (RecognitionTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_RelationDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (RelationDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_RepeatIdentifierDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (RepeatIdentifierDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ReportCard_TrackedDelete PRIMARY KEY CLUSTERED (EducationOrganizationId, GradingPeriodDescriptorId, GradingPeriodSchoolId, GradingPeriodSchoolYear, GradingPeriodSequence, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ResponseIndicatorDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ResponseIndicatorDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_RestraintEventReasonDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (RestraintEventReasonDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_RestraintEvent_TrackedDelete PRIMARY KEY CLUSTERED (RestraintEventIdentifier, SchoolId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ResultDatatypeTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ResultDatatypeTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_RetestIndicatorDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (RetestIndicatorDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_SchoolCategoryDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (SchoolCategoryDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_SchoolChoiceImplementStatusDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (SchoolChoiceImplementStatusDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_SchoolFoodServiceProgramServiceDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (SchoolFoodServiceProgramServiceDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_SectionAttendanceTakenEvent_TrackedDelete PRIMARY KEY CLUSTERED (CalendarCode, Date, LocalCourseCode, SchoolId, SchoolYear, SectionIdentifier, SessionName)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_Section_TrackedDelete PRIMARY KEY CLUSTERED (LocalCourseCode, SchoolId, SchoolYear, SectionIdentifier, SessionName)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_SeparationDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (SeparationDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_Session_TrackedDelete PRIMARY KEY CLUSTERED (SchoolId, SchoolYear, SessionName)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_SexDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (SexDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_SpecialEducationProgramServiceDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (SpecialEducationProgramServiceDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StaffAbsenceEvent_TrackedDelete PRIMARY KEY CLUSTERED (AbsenceEventCategoryDescriptorId, EventDate, StaffUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StaffEducationOrganizationContactAssociation_TrackedDelete PRIMARY KEY CLUSTERED (ContactTitle, EducationOrganizationId, StaffUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StaffLeaveEventCategoryDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (StaffLeaveEventCategoryDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StaffLeave_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, StaffLeaveEventCategoryDescriptorId, StaffUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StaffProgramAssociation_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StaffUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StaffSectionAssociation_TrackedDelete PRIMARY KEY CLUSTERED (LocalCourseCode, SchoolId, SchoolYear, SectionIdentifier, SessionName, StaffUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StateAbbreviationDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (StateAbbreviationDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentAssessment_TrackedDelete PRIMARY KEY CLUSTERED (AcademicSubjectDescriptorId, AdministrationDate, AssessedGradeLevelDescriptorId, AssessmentTitle, AssessmentVersion, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentCTEProgramAssociation_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentCompetencyObjective_TrackedDelete PRIMARY KEY CLUSTERED (GradingPeriodDescriptorId, GradingPeriodSchoolId, GradingPeriodSchoolYear, GradingPeriodSequence, Objective, ObjectiveEducationOrganizationId, ObjectiveGradeLevelDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentEducationOrganizationAssociation_TrackedDelete PRIMARY KEY CLUSTERED (EducationOrganizationId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentEducationOrganizationResponsibilityAssociation_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, EducationOrganizationId, ResponsibilityDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentGradebookEntry_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, DateAssigned, GradebookEntryTitle, LocalCourseCode, SchoolId, SchoolYear, SectionIdentifier, SessionName, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentHomelessProgramAssociation_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentLanguageInstructionProgramAssociation_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentLearningObjective_TrackedDelete PRIMARY KEY CLUSTERED (AcademicSubjectDescriptorId, GradingPeriodDescriptorId, GradingPeriodSchoolId, GradingPeriodSchoolYear, GradingPeriodSequence, Objective, ObjectiveGradeLevelDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentMigrantEducationProgramAssociation_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentNeglectedOrDelinquentProgramAssociation_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentParticipationCodeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (StudentParticipationCodeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentProgramAssociation_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentProgramAttendanceEvent_TrackedDelete PRIMARY KEY CLUSTERED (AttendanceEventCategoryDescriptorId, EducationOrganizationId, EventDate, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentSchoolAttendanceEvent_TrackedDelete PRIMARY KEY CLUSTERED (AttendanceEventCategoryDescriptorId, EventDate, SchoolId, SchoolYear, SessionName, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentSchoolFoodServiceProgramAssociation_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentSectionAssociation_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, LocalCourseCode, SchoolId, SchoolYear, SectionIdentifier, SessionName, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentSectionAttendanceEvent_TrackedDelete PRIMARY KEY CLUSTERED (AttendanceEventCategoryDescriptorId, EventDate, LocalCourseCode, SchoolId, SchoolYear, SectionIdentifier, SessionName, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentSpecialEducationProgramAssociation_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StudentTitleIPartAProgramAssociation_TrackedDelete PRIMARY KEY CLUSTERED (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_TeachingCredentialBasisDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (TeachingCredentialBasisDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_TechnicalSkillsAssessmentDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (TechnicalSkillsAssessmentDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_TelephoneNumberTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (TelephoneNumberTypeDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_TitleIPartAParticipantDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (TitleIPartAParticipantDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_TitleIPartASchoolDesignationDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (TitleIPartASchoolDesignationDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_TribalAffiliationDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (TribalAffiliationDescriptorId)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       SystemChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_VisaDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (VisaDescriptorId)
)
