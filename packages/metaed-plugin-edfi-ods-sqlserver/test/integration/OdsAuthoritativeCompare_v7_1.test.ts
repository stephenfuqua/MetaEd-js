...
describe('when generating ods and comparing it to data standard 5.0 pre authoritative artifacts for ODS/API 7.1', (): void => {
...
describe('when generating EducationOrganizationAuthorizationIndexes and comparing it to data standard 5.0 pre authoritative artifacts for ODS/API 7.1', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v7_1/');
  const outputDirectory = `${artifactPath}`;
  let coreResult: GeneratedOutput;
  let coreFileBaseName: string;
...
describe('when generating ods with simple extensions and comparing it to data standard 5.0 pre authoritative artifacts for ODS/API 7.1', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v7_1/');
...
describe('when generating ods with student transcript extensions and comparing it to data standard 5.0 pre authoritative artifacts for ODS/API 7.1', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v7_1/');
