...
describe('when domain entity extension has a common extension with a collection which overrides a collection of that common', () => {
  ...
  const core: string = 'edfi';
  const extension: string = 'extension';
  const coreCommon: string = 'CoreCommon';
  const coreDomainEntity: string = 'CoreDomainEntity';
  ...
  const coreDeIdentity: string = 'CoreDeIdentity';
  const coreCommonIdentity: string = 'CoreCommonIdentity';
  const scalarPlaceholder1: string = 'ScalarPlaceholder1';
  const scalarPlaceholder2: string = 'ScalarPlaceholder2';
  const collectionOnCommonExtension: string = 'CollectionOnCommonExtension';
  ...
  beforeAll(async () => {
    ...
    const coreNamespace: ?Namespace = metaEd.namespace.get(core);
...
describe('when domain entity extension has only a common collection which is extended', () => {
  ...
  const coreDeIdentity: string = 'CoreDeIdentity';
  const coreCommonIdentity: string = 'CoreCommonIdentity';
  const scalarPlaceholder: string = 'ScalarPlaceholder2';
  const collectionOnCommonExtension: string = 'CollectionOnCommonExtension';
