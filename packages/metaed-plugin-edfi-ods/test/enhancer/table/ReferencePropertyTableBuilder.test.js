...
describe('when building domain entity property table that is not an identity, required, optional, or a collection', () => {
  ...
  beforeAll(() => {
    ...
    domainEntity.data.edfiOds.ods_Properties.push(domainEntityEntityProperty1);
...
describe('when building identity domain entity property table', () => {
  const domainEntityPkName: string = 'DomainEntityPkName';
  const tables: Array<Table> = [];
  let table: Table;
  ...
  beforeAll(() => {
    ...
    domainEntity.data.edfiOds.ods_IdentityProperties.push(domainEntityPk);
    entityDomainEntityProperty.referencedEntity = domainEntity;
...
describe('when building collection domain entity property table', () => {
  ...
  beforeAll(() => {
    ...
    domainEntity.data.edfiOds.ods_Properties.push(domainEntityEntityProperty1);
    domainEntity.data.edfiOds.ods_IdentityProperties.push(domainEntityEntityProperty1);
    entityDomainEntityProperty.referencedEntity = domainEntity;
