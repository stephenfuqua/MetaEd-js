// @flow
import { newChoice, newChoiceProperty, newIntegerProperty, newStringProperty } from 'metaed-core';
import type { Choice, ChoiceProperty, IntegerProperty, StringProperty } from 'metaed-core';
...
describe('when creating columns for choice with is collection property', () => {
  ...
  beforeAll(() => {
    ...
    choice.data.edfiOds.ods_Properties.push(property);
...
describe('when creating columns for choice with two properties', () => {
  ...
  beforeAll(() => {
    ...
    choice.data.edfiOds.ods_Properties.push(stringProperty);
    choice.data.edfiOds.ods_Properties.push(integerProperty);
