...
describe('when enumeration is school year', () => {
  ...
  const year2: string = '1992';
  const year3: string = '1993';
  const year4: string = '1994';
  const year5: string = '1995';
  const year6: string = '1996';
  const year7: string = '1997';
  const year8: string = '1998';
  const year9: string = '1999';
