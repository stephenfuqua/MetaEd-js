...
import { GeneratedOutput, State, Namespace, GeneratorResult } from 'metaed-core';
import {
  buildMetaEd,
  buildParseTree,
  fileMapForFailure,
...
describe('when generating ods and comparing it to data standard 3.0 authoritative artifacts', () => {
...
describe('when generating ods with simple extensions and comparing it to data standard 3.0 authoritative artifacts', () => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v3/');
...
describe('when generating ods with student transcript extensions and comparing it to data standard 3.0 authoritative artifacts', () => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v3/');
