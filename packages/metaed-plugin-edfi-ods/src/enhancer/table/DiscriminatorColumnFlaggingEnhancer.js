// @flow
import type { EnhancerResult, MetaEdEnvironment, Namespace, SemVer, PluginEnvironment } from 'metaed-core';
import { versionSatisfies, NoTopLevelEntity } from 'metaed-core';
import { tableEntities } from '../EnhancerHelper';
import type { Table } from '../../model/database/Table';

const enhancerName: string = 'DiscriminatorColumnFlaggingEnhancer';
const targetTechnologyVersion: SemVer = '>=3.1';

export function enhance(metaEd: MetaEdEnvironment): EnhancerResult {
  if (
    !versionSatisfies(
      ((metaEd.plugin.get('edfiOds'): any): PluginEnvironment).targetTechnologyVersion,
