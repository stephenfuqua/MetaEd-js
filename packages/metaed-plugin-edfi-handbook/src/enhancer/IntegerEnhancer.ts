import { EnhancerResult, MetaEdEnvironment, SharedInteger, Namespace } from 'metaed-core';
...
function getTypeCharacteristicsFor(entity: SharedInteger): string[] {
...
export function enhance(metaEd: MetaEdEnvironment): EnhancerResult {
  metaEd.namespace.forEach((namespace: Namespace) => {
    ...
    (getEntitiesOfTypeForNamespaces([namespace], 'sharedInteger') as SharedInteger[]).forEach(entity => {
