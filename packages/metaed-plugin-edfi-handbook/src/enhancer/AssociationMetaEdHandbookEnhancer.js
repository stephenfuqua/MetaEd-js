...
export function enhance(metaEd: MetaEdEnvironment): EnhancerResult {
  const results: Array<HandbookEntry> = Array.from(metaEd.entity.association.values()).map(association =>
    createDefaultHandbookEntry(association, 'Association', metaEd),
  );
