// @flow
import type { Association, AssociationSubclass, MetaEdEnvironment, ValidationFailure } from 'metaed-core';
...
export function validate(metaEd: MetaEdEnvironment): Array<ValidationFailure> {
  ...
  metaEd.entity.associationExtension.forEach(associationExtension => {
    const extendedEntity: Association | AssociationSubclass | void =
      metaEd.entity.association.get(associationExtension.metaEdName) ||
      metaEd.entity.associationSubclass.get(associationExtension.metaEdName);
    if (extendedEntity) {
