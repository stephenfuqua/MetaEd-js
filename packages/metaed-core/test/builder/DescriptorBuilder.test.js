...
describe('when building descriptor source map with optional map type', () => {
  ...
  it('should have isMapTypeOptional', () => {
    expect(
      ((getDescriptor(namespace.entity, entityName).sourceMap: any): DescriptorSourceMap).isMapTypeOptional,
    ).toBeDefined();
  });
...
describe('when building descriptor source map with required map type', () => {
  ...
  it('should have isMapTypeRequired', () => {
    expect(
      ((getDescriptor(namespace.entity, entityName).sourceMap: any): DescriptorSourceMap).isMapTypeRequired,
    ).toBeDefined();
  });

  it('should have mapTypeEnumeration', () => {
    expect(
      ((getDescriptor(namespace.entity, entityName).sourceMap: any): DescriptorSourceMap).mapTypeEnumeration,
    ).toBeDefined();
  });
...
describe('when building required map type enumeration source map', () => {
  ...
  it('should have enumerationItems', () => {
    expect(
      ((getDescriptor(namespace.entity, entityName).mapTypeEnumeration.sourceMap: any): EnumerationSourceMap)
        .enumerationItems,
    ).toHaveLength(1);
  });
