...
export class MetaEdGrammarTalker {
  ...
  withStartNamespace(identifier: string, projectExtension: string | null = null): MetaEdGrammarTalker {
  ...
  withStartAssociation(identifier: string, metaEdId: string | null = null) {
  ...
  withStartAssociationExtension(identifier: string, metaEdId: string | null = null) {
  ...
  withStartAssociationSubclass(identifier: string, baseEntityName: string, metaEdId: string | null = null) {
  ...
  withStartCommon(identifier: string, metaEdId: string | null = null) {
  ...
  withStartChoice(identifier: string, metaEdId: string | null = null) {
  ...
  withStartCommonExtension(identifier: string, metaEdId: string | null = null) {
  ...
  withStartInterchange(identifier: string, metaEdId: string | null = null) {
  ...
  withStartInterchangeExtension(identifier: string, metaEdId: string | null = null) {
  ...
  withInterchangeElement(identifier: string, metaEdId: string | null = null) {
  ...
  withInterchangeIdentity(identifier: string, metaEdId: string | null = null) {
  ...
  withStartDomain(identifier: string, metaEdId: string | null = null) {
  ...
  withStartSubdomain(identifier: string, parentDomainName: string, metaEdId: string | null = null) {
  ...
  withDomainItem(identifier: string, metaEdId: string | null = null) {
  ...
  withStartDomainEntity(identifier: string, metaEdId: string | null = null) {
  ...
  withStartDomainEntityExtension(identifier: string, metaEdId: string | null = null) {
  ...
  withStartDomainEntitySubclass(identifier: string, baseEntityName: string, metaEdId: string | null = null) {
  ...
  withStartInlineCommon(identifier: string, metaEdId: string | null = null) {
  ...
  withStartFirstDomainEntity(entityName: string, metaEdId: string | null = null) {
  ...
  withStartSecondDomainEntity(entityName: string, metaEdId: string | null = null) {
  ...
  withEnumerationItem(shortDescription: string, documentation: string | null = null, metaEdId: string | null = null) {
  ...
  withStartEnumeration(identifier: string, metaEdId: string | null = null) {
  ...
  withStartDescriptor(identifier: string, metaEdId: string | null = null) {
  ...
  withQueryableOnlyDomainEntityProperty(identifier: string, documentation: string, metaEdId: string | null = null) {
    this.addPropertyEnter('DomainEntity');
  ...
  withIntegerIdentity(identifier: string, documentation: string, metaEdId: string | null = null) {
    this.addPropertyEnter('Integer');
  ...
  withIntegerIdentityRename(identifier: string, documentation: string, baseKeyName: string, metaEdId: string | null = null) {
    this.addPropertyEnter('Integer');
  ...
  addMaxMinValue(maxValue: string | null, minValue: string | null) {
    if (maxValue != null) {
  ...
  addMaxMinValueDecimal(maxValue: string | null, minValue: string | null) {
    if (maxValue != null) {
  ...
  addMaxMinLength(maxLength: string | null, minLength: string | null) {
    if (maxLength != null) {
  ...
  addWithContext(withContext: string | null, shortenTo: string | null = null) {
    if (withContext != null) {
  ...
  addIsWeakReference(isWeak: boolean | null) {
    if (!isWeak) return;
  ...
  withMetaEdId(metaEdId: string | null) {
    if (!metaEdId) return;
