...
import { TopLevelEntity, EnhancerResult, MetaEdEnvironment } from '@edfi/metaed-core';
...
export function enhance(metaEd: MetaEdEnvironment): EnhancerResult {
  getEntitiesOfTypeForNamespaces(Array.from(metaEd.namespace.values()), 'domainEntity').forEach((entity: TopLevelEntity) => {
    const tables: Table[] = [];
