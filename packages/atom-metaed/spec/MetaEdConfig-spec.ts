...
describe('MetaEdConfig', (): void => {
  describe('when the core metaEd source directory is updated', (): void => {
    ...
    it('ignores the change if the directory does not exist', (): void => {
    ...
    it('adds the source directory as a project', (): void => {
    ...
    it('adds the source directory first if projects already exist', (): void => {
      const newDirectory = 'newDirectory';
    ...
    it('removes the previous source directory if it exists', (): void => {
      const newDirectory = 'newDirectory';
      const existingProject = 'existingProject';
      spyOn(fs, 'existsSync').andReturn(true);
      spyOn(atom.project, 'getPaths').andReturn([existingProject]);
